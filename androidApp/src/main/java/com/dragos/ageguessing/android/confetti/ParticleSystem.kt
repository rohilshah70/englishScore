...
import com.dragos.ageguessing.android.confetti.emitters.ParticleExplodeEmitter
import com.dragos.ageguessing.android.confetti.emitters.ParticleFlowEmitter
import com.dragos.ageguessing.android.confetti.particle.Acceleration
import com.dragos.ageguessing.android.confetti.particle.EmissionType
import com.dragos.ageguessing.android.confetti.particle.Force
import com.dragos.ageguessing.android.confetti.particle.LifeTime
import com.dragos.ageguessing.android.confetti.particle.ParticleConfigData
import com.dragos.ageguessing.android.confetti.particle.Velocity
import com.dragos.ageguessing.android.confetti.particle.createForceVector
    ...
    val emitter = remember {
        ...
        when (emissionType) {
            is EmissionType.ExplodeEmission -> {
                ParticleExplodeEmitter(
                    emissionType.numberOfParticles,
                    particleConfigData
                )
            }
